function registerCameraRoutes(app, deps) {
  ...
  const STATIC_CAMERAS = {
    ...
    mexico: [
      { name: 'Zcalo',                  lat: 19.4326, lon: -99.1332 },
    ...
    saopaulo: [
      ...
      { name: 'Downtown - Praa S',     lat: -23.5505, lon: -46.6333 },
      { name: 'Marginal Tiet',          lat: -23.5209, lon: -46.6267 },
    ...
    bogota: [
      { name: 'Plaza Bolvar',           lat:  4.5981,  lon: -74.0760 },
    ...
    lima: [
      ...
      { name: 'Miraflores Malecn',      lat: -12.1219, lon: -77.0301 },
      { name: 'Javier Prado Ave',        lat: -12.0875, lon: -77.0508 },
      { name: 'Jorge Chvez Airport',    lat: -12.0219, lon: -77.1143 },
    ],
    santiago: [
    ...
    paris: [
      ...
      { name: 'Champs-lyses & Arc',    lat: 48.8738, lon:  2.2950 },
      ...
      { name: 'Montmartre - Sacr-Cur', lat: 48.8867, lon:  2.3431 },
    ],
    berlin: [
      ...
      { name: 'Kurfrstendamm',          lat: 52.5027, lon: 13.3317 },
    ...
    madrid: [
      ...
      { name: 'Gran Va',                lat: 40.4200, lon: -3.7025 },
    ...
    vienna: [
      ...
      { name: 'Schnbrunn Palace',       lat: 48.1845, lon: 16.3120 },
    ...
    stockholm: [
      ...
      { name: 'Djurgrden',              lat: 59.3250, lon: 18.1088 },
      { name: 'Kungstrdgrden',         lat: 59.3319, lon: 18.0712 },
      { name: 'Arlanda Airport',         lat: 59.6519, lon: 17.9186 },
    ],
    lisbon: [
      { name: 'Praa do Comrcio',       lat: 38.7080, lon: -9.1367 },
      { name: 'Alfama District',         lat: 38.7136, lon: -9.1313 },
      { name: 'Belm Tower',             lat: 38.6916, lon: -9.2160 },
      { name: 'Marqus de Pombal',       lat: 38.7259, lon: -9.1493 },
    ...
    istanbul: [
      ...
      { name: 'Atatrk Airport',         lat: 40.9769, lon: 28.8146 },
    ],
    // Middle East
    dubai: [
